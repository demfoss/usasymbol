...
namespace USASymbol.Models.Content
{
    public class AmphibianContent
    {
        ...
        public List<AmphibianSection> Sections { get; set; } = new();
        public List<AmphibianFaq> Faq { get; set; } = new();
        public List<AmphibianSource> Sources { get; set; } = new();
        public List<QuickFactItem> QuickFacts { get; set; } = new();
        public List<VisualAsset> VisualAssets { get; set; } = new();
    }

    public class AmphibianSection : IContentSection
    {
        ...
        // Where the amphibian is found (location section only), shown on a Leaflet map
        public List<AmphibianSite> Sites { get; set; } = new();
    }

    public class AmphibianSite
    {
        public string Name { get; set; } = string.Empty;
    ...
    public class AmphibianFaq : IFaqItem
    {
        public string Question { get; set; } = string.Empty;
        public string Answer { get; set; } = string.Empty;
    }

    public class AmphibianSource : ISource
    {
        public string Name { get; set; } = string.Empty;
