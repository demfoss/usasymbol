...
namespace USASymbol.Models.Content
{
    public class BeverageContent
    {
        ...
        public List<BeverageSection> Sections { get; set; } = new();
        public List<BeverageSource> Sources { get; set; } = new();
        public List<BeverageFaq> Faq { get; set; } = new();
    ...
    public class BeverageSection : IContentSection
    {
        ...
        public List<BeverageSubsection>? Subsections { get; set; }
    ...
    public class BeverageSubsection : IContentSubsection
    {
    ...
    public class BeverageSource : ISource
    {
    ...
    public class BeverageFaq : IFaqItem
    {
